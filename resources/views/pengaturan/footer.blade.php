...
<form action="{{ url('admin/home/pengaturan/update/footer/' . $value->id) }}" method="POST">
    @csrf
    <div class="card">
        <div class="card-body">
            <p class="text-lg-start" style="font-size: 18px; color: #0B4149; font-weight: 800">Footer</p>
            <hr class="hr hr-blurry" />
            <div class="container">
                <div class="col">
                    <p class="text-lg-start" style="color: #4E5B5C">Deskripsi Footer</p>
                    <input name='deskripsi_footer' type="text" class="form-control" placeholder="Isi Deskripsi Footer"
                        id="example-text-input" value="{{ $value->deskripsi_footer }}">
                </div>
                <br>
                <div class="col">
                    <p class="text-lg-start" style="color: #4E5B5C">Nomor Telepon</p>
                    <input name='nomor_telepon' type="text" class="form-control" id="example-text-input"
                        value="{{ $value->nomor_telepon }}">
                </div>
                <br>
                <div class="col">
                    <p class="text-lg-start" style="color: #4E5B5C">E-mail</p>
                    <input name='email' type="text" class="form-control" placeholder="Isi E-mail"
                        id="example-text-input" value="{{ $value->email }}">
                </div>
                <br>
                <div class="row">
                    <div class="col">
