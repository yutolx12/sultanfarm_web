    ...
    <div class="container px-5 mt-2">
        ...
        <div class="col-lg-12">
            ...
            <div class="product-cards-container">
                ...
                <div class="product-card" style="width: 18rem; height: 32rem;">
                    <p class="text-center" style="color: #212E30; font-weight: 700; text-align: center">Umur 0 Tahun 0
                        Bulan 00 Hari</p>
        ...
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-5 mb-lg-0 text-center text-lg-start">
                    ...
                    <p style="color: white;"> <i class="bi bi-whatsapp me-2"></i> <i class="bi bi-instagram me-2"></i>
                        <i class="bi bi-facebook me-2"></i> <i class="bi bi-youtube me-2"></i><i
                            class="bi bi-music-note me-2"></i>
                    </p>
                </div>
            </div>
        </div>
