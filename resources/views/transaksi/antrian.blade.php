...
<ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link " aria-current="page" href="{{ route('penjualan') }}">Penjualan</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="{{ route('antrian') }}">Antrian</a>
    </li>
    <li class="nav-item">
        ...
        <table class="table" id="table1">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primairy" href="" style="background-color: #228896; color:white" data-bs-toggle="modal"
                        data-bs-target="#modalGambar">
                        <span class="btn-label">Lihat Gambar</span></button>
                    </td>
                    <td>
                        <audio controls="true">
                            <source src="{{ asset('audio/musik1.mp3')}}" type="audio/mpeg">
                            </audio>
                    </td>
                    ...
                    <td>
                        ...
                        <a type="button" class="btn btn-success" href="{{ route('penjualan') }}">
                            <span class="btn-label"><i class="bi bi-check-lg"></i></span></a>
                ...
                <tr>
                    ...
                    <td>
                       <audio controls="true">
                        <source src="{{ asset('audio/musik2.mp3')}}" type="audio/mpeg">
                        </audio>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <audio controls="true">
                            <source src="{{ asset('audio/musik3.mp3')}}" type="audio/mpeg">
                            </audio>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <audio controls="true">
                            <source src="{{ asset('audio/musik4.mp3')}}" type="audio/mpeg">
                            </audio>
                    </td>
...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link " aria-current="page" href="{{ route('historypenjualan') }}">History Penjualan</a>
    </li>
        ...
        <table class="table" id="table1">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <p class="text-lg-start" style="color: #3B484A">Paket Breeding 1 <span class="fw-normal"
                                style="padding-left:9px; color: #3B484A">(Rp. 15.000.000)</span></p>
                                <p class="text-lg-start" style="color: #3B484A">2 Paket</p>
                                <p class="text-lg-start" style="color: #228896">Rp. 30.000.000</p>

                        <p class="text-lg-start" style="color: #3B484A">Paket Breeding 2 <span
                                class="fw-normal" style="padding-left:5px; color: #3B484A;">(Rp 30.000.000)</span></p>
                                <p class="text-lg-start" style="color: #3B484A">1 Paket</p>
                                <p class="text-lg-start" style="color: #228896">Rp. 30.000.000</p>
                    </td>
                    <td>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700"> Rp. 60.000.000</p>
                ...
                <tr>
                    <td>2</td>
                    <td>
                        <p class="text-lg-start" style="color: #228896; font-weight: 700">09876545677</p>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700">22-07-2023 14:46:31</p>
                        <p class="text-lg-start" style="color: #3B484A">Ryzen</p>
                    </td>
                    <td>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700">B2023270001 </p>
                        <p class="text-lg-start" style="color: #3B484A">Domba Taxel <span class="fw-normal"
                            style="padding-left:9px; color: #3B484A">(Rp. 5.000.000)</span></p>
                            <p class="text-lg-start" style="color: #3B484A">1 Ekor</p>
                            <p class="text-lg-start" style="color: #228896">Rp. 5.000.000</p>

                            <p class="text-lg-start" style="color: #3B484A; font-weight: 700">B2023270002 </p>
                            <p class="text-lg-start" style="color: #3B484A">Domba Dormas <span class="fw-normal"
                                style="padding-left:9px; color: #3B484A">(Rp. 6.000.000)</span></p>
                                <p class="text-lg-start" style="color: #3B484A">1 Ekor</p>
                                <p class="text-lg-start" style="color: #228896">Rp. 6.000.000</p>
                    </td>
                    <td>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700"> Rp. 11.000.000</p>
                ...
                <tr>
                    <td>3</td>
                    <td>
                        <p class="text-lg-start" style="color: #228896; font-weight: 700">09876545679</p>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700">21-07-2023 14:46:31</p>
                        <p class="text-lg-start" style="color: #3B484A">Radeon</p>
                    </td>
                    <td>

                            <p class="text-lg-start" style="color: #3B484A; font-weight: 700">B2023270004 </p>
                            <p class="text-lg-start" style="color: #3B484A">Domba Taxel <span class="fw-normal"
                                style="padding-left:9px; color: #3B484A">(Rp. 3.000.000)</span></p>
                                <p class="text-lg-start" style="color: #3B484A">1 Ekor</p>
                                <p class="text-lg-start" style="color: #228896">Rp. 3.000.000</p>

                    </td>
                    <td>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700"> Rp. 3.000.000</p>
